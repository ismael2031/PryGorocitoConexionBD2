...
namespace PryGorocitoConexionBD2
{
    public partial class Form1 : Form
    {
        ...
        private void BtnCargarcontactos_Click(object sender, EventArgs e)
        {
            ...
            colTelefono.HeaderText = "Categoria"; // Título visible
            colTelefono.DataPropertyName = "Categoria"; // Nombre de campo de la tabla
            colTelefono.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            dgvContactos.Columns.Add(colCategoria);
